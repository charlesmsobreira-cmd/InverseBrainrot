...
export default function FlashcardsPage() {
  ...
  return (
    <main className="min-h-screen p-8 md:p-12 overflow-hidden flex flex-col relative transition-colors duration-1000 bg-transparent text-[#1D1D1F]">
      ...
      <div className="flex justify-between items-center relative z-20 mb-12">
        ...
        <div className="flex items-center gap-2 px-4 py-2 rounded-full shadow-sm border transition-colors duration-1000 bg-white border-black/5">
      ...
      {sessionFinished ? (
        <div className="flex-1 flex flex-col items-center justify-center relative z-10 w-full max-w-lg mx-auto">
          <motion.div 
            ...
            className="p-12 rounded-[3rem] shadow-xl border text-center w-full transition-colors duration-1000 bg-white border-black/5"
          >
            <CheckCircle size={64} className="mx-auto text-emerald-500 mb-6" weight="duotone" />
            <h2 className="text-4xl font-black uppercase tracking-tighter mb-4 transition-colors duration-1000 text-titanium-100">Sessão Concluída!</h2>
            <p className="mb-8 transition-colors duration-1000 text-titanium-400">Você revisou todas as cartas do deck básico de Italiano por agora.</p>
            <button 
              onClick={restart}
              className="px-10 py-4 bg-black text-white rounded-2xl font-bold uppercase tracking-widest text-[10px] hover:bg-zinc-800 transition-all shadow-xl shadow-black/10"
            >
              Reiniciar Baralho
            </button>
          </motion.div>
