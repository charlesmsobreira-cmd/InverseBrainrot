...
import { ArrowLeft, CurrencyDollar } from '@phosphor-icons/react';
      ...
      >
        ...
        <div className="mt-12 p-12 glass-panel rounded-[3rem] max-w-4xl">
          <p className="text-2xl text-titanium-300 font-light leading-relaxed">
            Mapeando fluxos de capital e alocações estratégicas... <br />
            Configurando a visão de longo prazo para crescimento sustentável.
          </p>
        </div>
      </motion.div>
    </main>
